...
namespace ArcGISMonitorExcelReporterLib.Client
{
    ...
    public sealed class ArcGisMonitorClient : IDisposable
    {
        ...
        public async Task<QueryResponse<CollectionFeature>> QueryCollectionsAsync(
            ...
            CancellationToken cancellationToken = default) => await PostAsync<CollectionQueryRequest, QueryResponse<CollectionFeature>>(
        ...
        public async Task<QueryResponse<MetricFeature>> QueryMetricsAsync(
            ...
            CancellationToken cancellationToken = default) => await PostAsync<MetricQueryRequest, QueryResponse<MetricFeature>>(
        ...
        /// <summary>
        /// Queries components directly from ArcGIS Monitor using the /monitoring/components/query endpoint.
        /// </summary>
        /// <param name="request">The component query request parameters.</param>
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>A query response containing component features.</returns>
        /// <exception cref="InvalidOperationException">Thrown if no token is configured or the token is expired.</exception>
        /// <exception cref="HttpRequestException">Thrown if the HTTP request fails.</exception>
        public async Task<QueryResponse<ComponentFeature>> QueryComponentsAsync(
            ComponentQueryRequest request,
            CancellationToken cancellationToken = default) => await PostAsync<ComponentQueryRequest, QueryResponse<ComponentFeature>>(
